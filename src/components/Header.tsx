    ...
    <div>
        <main className='mt-4 md:mt-24 '>
            ...
            <div className='m-auto w-fit mt-8 '>
                <button className='rounded-4xl px-7 py-2 bg-black text-white mr-3'><Link href={`/${Routes.AUTH}/${Pages.REGISTER}`}>Sign Up</Link></button>
                <button className='rounded-4xl px-7 py-2  text-black bg-gray-200'><Link href={`/${Routes.AUTH}/${Pages.LOGIN}`}>Log In</Link></button>
            </div>
        </main>
    </div>
  )
